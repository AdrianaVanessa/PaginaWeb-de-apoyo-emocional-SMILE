...
<nav class="bg-custom navbar navbar-expand-lg d-lg-none">
    <div class="container-fluid bg-custom container-fluid">
        ...
        <div class="collapse navbar-collapse bg-custom" id="menuLateral">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="chat.php">Chats</a>
                </li>
                <li class="nav-item">
...
<style>
    ...
    .bg-custom {
        background-color: #E6836D; /* color menu lateral */
    }
    .bg-custom-principal {
        background-color: #FFEEE5; /* color pantalla principal */
    }
    .bg-custom-user {
        background-color: #FFFFFF; /* color pantalla user */
    }
    .color-white {
    color: white; 
}
